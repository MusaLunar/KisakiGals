...
**Galgame 收藏、游玩时长与作品探索管理器** · Flutter Windows 桌面应用 · VIBE CODING
...
- 🧭 **探索**：一页两种模式 —— 「探索」浏览 VNDB / Bangumi 榜单（评分、年份、标签筛选，右键栏与游戏库一致）并一键入库；「资源」聚合多个资源站的发布页，并发搜索、按相关度排序，一键打开下载页或直接入库
...
- **探索 → 资源**：输入中文名效果最好，结果按相关度排序；「下载页」用浏览器打开，「入库」直接进入搜刮流程。想找新作品可切到「探索」模式浏览榜单
